...
final class LocalStockDataAdded extends LocalStockDataState {
  // Optionally, include any additional information for the "added" state if needed.
  const LocalStockDataAdded();
}
